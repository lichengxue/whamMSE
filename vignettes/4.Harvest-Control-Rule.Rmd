...
age composition data, we use a self-weighting likelihood
("logistic-normal-miss0") in both the OM and EM. More details about
options of self-weighting likelihoods can be found in `make_em_input()`
function. For Hockey-stick harvest control rule, users need to set the
...
mods[[3]] = loop_through_fn(om = om_with_data, 
                            ...
                            NAA_re_om = NAA_re, 
                            move_om = move,
                            age_comp_om = "logistic-normal-miss0", # Note: not multinomial!
                            M_em = M_em, 
                            sel_em = sel_em, 
                            NAA_re_em = NAA_re_em, 
                            move_em = NULL,
