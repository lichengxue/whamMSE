...
Users must install wham first with all required dependencies:

``` r
install.packages("devtools") 
devtools::install_github("timjmiller/wham", dependencies=TRUE, ref="devel") # "multi-stock" version of wham
```
