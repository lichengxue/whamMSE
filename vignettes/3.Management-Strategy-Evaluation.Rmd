...
![Figure
1](EM_figures/Separate_Assessment_Models_with_NAA_Random_Effects.png){width="600"}
...
![Figure
3](EM_figures/One_Area_Model_with_Catch_Aggregated_and_with_NAA_Random_Effects.png){width="600"}
...
![Figure
4](EM_figures/Two_Area_Model_with_Fixed_Movement_and_with_NAA_Random_Effects_with_Movement_Arrows.png){width="600"}
...
![Figure
5](EM_figures/Two_Area_Model_with_No_Movement_and_with_NAA_Random_Effects.png){width="600"}
...
![Figure
6](EM_figures/Two_Area_Model_with_No_Movement_and_with_Rec_Random_Effects.png){width="600"}
...
plot(SSB_s1[[1]][14:23], type = "l", col = "blue", ylab = "SSB", xlab = "Year") # only extract SSB from the last 10 years
colors <- c("red","green","purple","orange","brown")
for (i in 2:6) {
  lines(SSB_s1[[i]][14:23], col = colors[i-1],lty = i)
}
legend("topright",legend = paste0("EM ", 1:6), col = c("blue",colors),lty=1:6, cex=0.8)

Catch_s1 <- lapply(mods, function(mod) mod$om$rep$pred_catch[,1])
plot(Catch_s1[[1]][14:23], type = "l", col = "blue", ylab = "Catch", xlab = "Year")
colors <- c("red","green","purple","orange","brown")
for (i in 2:6) {
...
![Figure 7](Example_plots/plot_ex3.png){width="600"}
