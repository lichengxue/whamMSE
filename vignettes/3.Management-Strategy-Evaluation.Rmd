...
| EM3   | Separate panmictic                   | Number of regions | No              | NAA            | No global SPR-based | Separate single stock assessment model                              |
| EM4   | Spatially disaggregated              | Number of regions | No              | NAA            | Global SPR-based    | Spatially disaggregated without movement                               |
| EM5   | Spatially explicit                   | Number of regions | Yes (fix.)      | NAA, movement  | Global SPR-based    | Spatially disaggregated with movement fixed as known                                        |
| EM6   | Spatially explicit                   | Number of regions | Yes (est.)      | NAA, movement       | Global SPR-based    | Spatially disaggregated with movement estimated given a prior and sd|
