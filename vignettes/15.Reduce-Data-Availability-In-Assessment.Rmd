...
This vignette introduces how to run MSE with reduced data availability in assessment (data limited situations in the future):
...
library(wham)
# library(whamMSE)
devtools::document("C:/Users/chengxue.li/whamMSE/") # "whamMSE" package
...
### 11. An even worse case scenario (no data for survey 1 in the future)
```{r, eval = FALSE}
