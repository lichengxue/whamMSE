...
## Generate OM and Perform Self-test
...
move <- generate_move(basic_info = basic_info, move.type = 2, move.rate = 0.3, move.re = "constant") # Note: default is move = 0.3 (constant) for stock1 and 0.1 (constant) for the other stocks
...
move <- generate_move(basic_info = basic_info, move.type = 1, move.rate = 0.3, move.re = "constant") # Note: default is 0.3 for stock1 and 0 for the rest of stocks
```
...
```{r, eval=FALSE}
basic_info <- generate_NAA_where(basic_info = basic_info, move.type = 2)
move <- generate_move(basic_info = basic_info, move.type = 2, move.rate = 0.3, move.re = "iid_y", move.sigma = 0.5) # movement rate is iid (sigma = 0.5) across years
```
...
```{r, eval=FALSE}
basic_info <- generate_NAA_where(basic_info = basic_info, move.type = 2)
move <- generate_move(basic_info = basic_info, move.type = 2, move.rate = 0.3, move.re = "iid_a", move.sigma = 0.5) # movement rate is iid (sigma = 0.5) across ages
```
...
```{r, eval=FALSE}
basic_info <- generate_NAA_where(basic_info = basic_info, move.type = 2)
move <- generate_move(basic_info = basic_info, move.type = 2, move.rate = 0.3, move.re = "ar1_y",move.sigma = 0.5, move.rho_y = 0.5) # movement rate is ar1 (sigma = 0.5, rho_y = 0.5) across years
```
...
basic_info <- generate_NAA_where(basic_info = basic_info, move.type = 2)
move <- generate_move(basic_info = basic_info, move.type = 2, move.rate = 0.3, move.re = "ar1_a",move.sigma = 0.5, move.rho_a = 0.5) # movement rate is ar1 (sigma = 0.5, rho_a = 0.5) across ages
```
