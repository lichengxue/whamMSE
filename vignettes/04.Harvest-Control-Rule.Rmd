...
hcr <- list()
hcr$hcr.type = 3
hcr$hcr.opts <- list(max_percent = 75, min_percent = 0.01, BThresh_up = 0.5, BThresh_low = 0) 
```
...
plot(SSB_s1_m1[1:23], col = "red", type = "o", ylab = "SSB", xlab = "Year") 
...
Catch_r1_m1 <- mods[[1]]$om$rep$pred_catch[,1] # Region 1 Catch in model 1
Catch_r1_m2 <- mods[[2]]$om$rep$pred_catch[,1] # Region 1 Catch in model 2
Catch_r1_m3 <- mods[[3]]$om$rep$pred_catch[,1] # Region 1 Catch in model 2
plot(Catch_r1_m1[1:23], col = "red", type = "o", ylab = "Catch", xlab = "Year") # Extract catch from last 10 years
