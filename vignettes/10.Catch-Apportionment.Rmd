...
info <- generate_basic_info(base.years = year_start:year_end,
...
#### Option 1 (weight_type = 1): Assign equal weights to all regions.
```{r, eval = FALSE}
mod = list()
...
mod[[1]] = loop_through_fn(om = om_with_data,
                           ...
                           hcr.type = 1,
                           weight_type = 1) # Uniform: Assign equal weights to all regions 
```

#### Option 2 (weight_type = 2): User specified weights for catch apportionment.
```{r, eval = FALSE}
mod[[2]] = loop_through_fn(om = om_with_data,
                           ...
                           year.use = 20, # number of years of data you want to use in the assessment model
                           hcr.type = 1,
                           weight_type = 2, # User defined
                           user_weights = c(0.4,0.6)) 
```

#### Option 3 (weight_type = 3): Weights are calculated using regional catch averaged over x years.
...
mod[[3]] = loop_through_fn(om = om_with_data,
                           ...
                           year.use = 20, # number of years of data you want to use in the assessment model
                           hcr.type = 1,
                           weight_type = 3, # Catch history
                           weight_years = 10) # average over the most recent 10 years
```

#### Option 4 (weight_type = 4): Weights are calculated using regional surveyed biomass averaged over x years.
...
mod[[4]] = loop_through_fn(om = om_with_data,
                           ...
                           year.use = 20, # number of years of data you want to use in the assessment model
                           hcr.type = 1,
                           weight_type = 4, # survey average
                           weight_years = 5) # average over the most recent 5 years
```

#### Option 5 (weight_type = 5): Weights are calculated using regional recruitment.
