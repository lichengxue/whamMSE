...
Users must install the **meta-population** wham (including natal homing functionality) first with all required dependencies:
...
Users can also download wham (only natal homing functionality) from Tim Miller's github:
