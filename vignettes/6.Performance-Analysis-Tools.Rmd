...
Suppose you run management strategy evaluation for n realizations following Example 5, you can use the  code below to plot the results. Remember mods[[1]] is a list that contains results of the performance of EM1 in different realizations. 
...
![Figure 1](Report(2)/Performance_Metrics.pdf)
